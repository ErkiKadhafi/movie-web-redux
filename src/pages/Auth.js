    ...
    return (
        <section className="h-screen">
            <div className="layout h-full flex justify-center lg:justify-between items-center lg:space-x-32">
                ...
                <form className="lg:w-2/5" method="POST">
                    ...
                    <div class=" flex relative mb-6">
                        <span class="rounded-l-lg inline-flex items-center px-3 border-t bg-black-black/10 border-l border-b border-gray-gray/700 text-gray-gray/300 shadow-sm text-sm">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                        ...
                        <input
                            ...
                            id="rounded-email"
                            name="email"
                            class="w-full rounded-r-lg  flex-1 border-r border-t border-b border-gray-gray/700 py-5 px-4 bg-black-black/10 text-gray-gray/300 placeholder-gray-gray/600 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                            placeholder="Email"
                        />
                    </div>
                    <div className=" flex relative mb-6">
                    ...
                    {location.pathname === "/login" ? (
                        <Link to="/signup">
                            <span className="text-primary-primary/400 hover:underline">
